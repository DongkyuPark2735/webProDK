...
%>
  <form action="modifyOk.jsp" method="post" name="modify_frm" onsubmit="reture infoConfirm()">
  	<table>
  		<caption>정보수정</caption>
  		  <tr>
  			...
  			<tr>
  		  	<th>이름</th><td><input type="text" name="name" value="<%=name%>" required="required"></td>
  			</tr>
  			<tr>
  		  	<th>전화번호</th>
  		  	<td>
  		  		<select name="phone1">
  		  			<option></option> <!--  null이 들어올수있기에 phone1.equels(010)말고 010.equels(phone1) -->
  		  			...
  		  			<option <%if("032".equals(phone1))
  		  					out.print("selected='selected'");%>>032</option>
  		  		</select> - 
  		  		<input type="text" name="phone2" size="2" value='<%=phone2!=null? phone2:""%>'> - <!--size주기위해 text함-->
