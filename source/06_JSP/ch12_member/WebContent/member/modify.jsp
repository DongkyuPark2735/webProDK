...
<body>
		...
		<table>
			...
			<tr>
				...
				<td><select name="phone1">
						<option></option>
						<!--  null이 들어올수있기에 phone1.equels(010)말고 010.equels(phone1) -->
						<option
	...
	out.print("selected='selected'");%>>032</option>
				</select> - <input type="text" name="phone2" size="2"
					value='<%=phone2 != null ? phone2 : ""%>'> - <!--size주기위해 text함-->
					<input type="text" name="phone3" size="2"
					value='<%=phone3 != null ? phone3 : ""%>'></td>
			</tr>
			<tr>
				<th>성별</th>
				<td>
			...
			<tr>
				<td colspan="2"><input type="submit" value="정보수정"> <input
					type="reset" value="취소" onclick="history.back()"> <input
