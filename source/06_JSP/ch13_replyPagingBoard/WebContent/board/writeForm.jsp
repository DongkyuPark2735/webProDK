...
<%
	...
	if(request.getParameter("num") != null){ // 정보가 있으면 작성된 글에서 넘어온 페이지
...
%>
  <form action="writePro.jsp" method="post">
  	...
  	<table>
  		<caption>게시판</caption>
  		<tr>
  			<th>작성자</th><td><input type="text" name="writer" required="required"></td>
  		</tr>
  		<tr>
  			<th>제목</th><td><input type="text" name="subject" required="required" 
  														value="<%if(dto.getSubject()!=null) out.println("답 : "+dto.getSubject()); %>"></td>
  		</tr>
  		<tr>
  			<th>이메일</th><td><input type="email" name="email"></td>
  		</tr>
  		<tr>
  			<th>본문</th><!--textarea는 열자마자 닫아야함 빈칸이 들어감  -->
