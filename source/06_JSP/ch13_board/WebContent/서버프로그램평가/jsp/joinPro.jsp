...
<body>
	...
	if (idchek == CustomerDAO.SUCCESS) {
		...
		if (result == CustomerDAO.SUCCESS) {
			...
			out.println("<script>alert('회원가입 감사합니다.로그인 이후에 서비스를 이용하세요');" + "location.href='login.jsp'; </script>");
		}
	} else if (idchek == CustomerDAO.FAIL) {
		out.println("<script>alert('회원가입이 실패되었습니다. 중복된 id입니다.');" + "history.back(); </script>");
	}
	%>
</body>
</html>