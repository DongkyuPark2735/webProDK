...
//
//		BookLip[] b1 = { new BookLip("111", "java", "홍길동"), new BookLip("222", "oracle", "신길동"),
//				new BookLip("333", "mysql", "유길동"), new BookLip("444", "web", "고길동"),
//				new BookLip("555", "jsp", "김길동") };
//		
...
//
//		do {
//			System.out.println("1.책 대출 | 2. CD 대출 | 3.책 반납 | 4.CD 반납  | 5.책 list |" 
//								+ "6. CD list | 0. 종료");
//			fn = scanner.nextInt();
//			switch (fn) {
//			case 1:// 대출 : 1.책이름 입력 2.책 조회 3.책 상태 확인 4.대출인입력 5.대출일 입력 6.대출매소드 호출
//				System.out.println("대출 하고자 하는 CD 이름은?");
...
//				
//			case 2:
//				System.out.println("대출 하고자 하는 CD이름은?");
//				bTitle = scanner.next(); 
//				
//				for (idx = 0; idx < b1.length; idx++) {
//					if (bTitle.equals(b1[idx].getBookTitle())) {
